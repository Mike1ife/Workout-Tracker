              ...
              <>
                ...
                <div className="food-preview">
                  ...
                  <p className="quantity-summary">
                    {getSelectedFoodData().servingSize}g × {quantity}  serving
                  </p>
                </div>
              </>
            )}
      ...
      <div className="modal-overlay">
        <div className="modal-content">
          ...
          <div className="form-container">
            ...
            <div className="form-group">
              <label className="form-label">
                Quantity (servings of {editingFoodLog.servingSize}g)
              </label>
              <div className="quantity-controls">
                <button
                  type="button"
            ...
            <div className="food-preview">
              ...
              <div className="macro-grid">
                <div className="macro-item">
                  <span className="macro-label">Calories</span>
                  <span className="macro-value">
                    {calculateTotal(editingFoodLog.calories)} cal
                  </span>
                </div>
                <div className="macro-item">
                  <span className="macro-label">Carbs</span>
              ...
              <div className="food-grid">
                {foods.map((food, i) => (
                  <div key={i} className="food-card food-card-relative">
                    ...
                    <p className="food-serving-text">per {food.servingSize}</p>
